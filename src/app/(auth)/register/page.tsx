        ...
        >
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 tracking-tight">
              CREATE
              <span className="text-[#00FF41]"> ACCOUNT</span>
            </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-8 px-6 py-4 bg-[#00FF41] text-black font-bold hover:bg-[#00CC33] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 group"
            >
              {loading ? (
          ...
          <div className="mt-8 grid grid-cols-2 gap-4">
            {[
              ...
              <div key={feature} className="flex items-center gap-2 text-sm text-gray-500">
                <span className="text-[#00FF41]">{Icons.check}</span>
